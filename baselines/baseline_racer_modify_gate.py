...
class BaselineRacer(object):
    ...
    def get_ground_truth_gate_poses(self):
        ...
        self.gate_names_sorted = [gate_names_sorted_bad[gate_idx] for gate_idx in gate_indices_correct]
        self.gate_poses_ground_truth = []
        for gate_name in self.gate_names_sorted:
...
def main(args):
    ...
    name_gate0 = baseline_racer.gate_names_sorted[0]
    print(name_gate0)
    print(baseline_racer.airsim_client.simGetObjectPose(name_gate0))
    scale = baseline_racer.airsim_client.simGetObjectPose(name_gate0)
    scale.x_val = 3
    scale.y_val = 4
    scale.z_val = 5
    print(baseline_racer.airsim_client.simSetObjectScale(name_gate0, scale))
