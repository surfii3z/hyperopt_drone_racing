...
class BaselineRacer(object):
    def __init__(self, drone_name = "drone_1", viz_traj=True, viz_traj_color_rgba=[1.0, 0.0, 0.0, 1.0], viz_image_cv2=True):
        ...
        # self.best_race_time_arr = [5.77, 7.26, 9.2, 11.65, 14.83, 18.47, 27.65, 33.64, 38.74, 43.2, 44.9, 46.83, 50.29, 51.24]
        ...
        # self.best_hyper.v = np.array([32.32, 17.5, 28.41, 24.01, 34.94, 31.78, 21.19, 25.55, 33.69, 17.14, 20.4, 16.18, 11.7, 33.22])
        # self.best_hyper.a = np.array([109.41, 142.36, 173.54, 126.35, 106.84, 78.8, 156.04, 163.12, 120.11, 122.11, 117.34, 178.7, 50.0, 146.64])
        # self.best_hyper.d = np.array([3.5, 4.12, 3.66, 4.74, 3.92, 4.67, 4.34, 5.38, 3.5, 3.5, 3.87, 3.6, 4.62, 2.0])
# 
    ...
    def update_hyper_paramters(self, curr_race_time_arr, best_race_time_arr):
        ...
        new_hyper.random_initialization()
...
def main(args):
    ...
    # new_hyper.v = np.array([32.32, 17.5, 28.41, 24.01, 34.94, 31.78, 21.19, 25.55, 33.69, 17.14, 20.4, 16.18, 11.7, 33.22])
    # new_hyper.a = np.array([109.41, 142.36, 173.54, 126.35, 106.84, 78.8, 156.04, 163.12, 120.11, 122.11, 117.34, 178.7, 50.0, 146.64])
    # new_hyper.d = np.array([3.5, 4.12, 3.66, 4.74, 3.92, 4.67, 4.34, 5.38, 3.5, 3.5, 3.87, 3.6, 4.62, 2.0])
    # new_hyper.d[-1] = 2
...
if __name__ == "__main__":
    ...
    data_logging = open("data_logging_RS.txt", "w")
